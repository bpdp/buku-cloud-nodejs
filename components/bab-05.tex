...
Node Package Manager atau npm merupakan bilah alat berbasis baris perintah. Sama seperti kebanyakan bilah alat berbasis baris perintah lain, npm memiliki struktur perintah \textile{npm perintah argumen}. Installasi paket pustaka dilakukan dengan perintah berikut :
...
Menghapus paket pustaka menggunakan npm pada dasarnya hampir sama dengan saat memasang paket, namun dengan perintah \textile{uninstall}. Berikut perintah lengkapnya.
