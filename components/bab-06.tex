...
Selain itu, ada beberapa tambahan file (routes/employee.js dan views/employee.jade} dan perubahan yang cukup signifikan pada file views/index.jade.
...
\lstset{language=plain,caption=views/employee.jade}
\begin{lstlisting}
extends layout
...
\lstset{language=plain,caption=views/index.jade}
\begin{lstlisting}
extends layout
