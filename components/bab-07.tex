...
\lstinputlisting{src/non-nodejs/bab-07/express-dir-asli.txt}
...
\lstinputlisting{src/non-nodejs/bab-07/express-dir-jadi-mvc.txt}
...
\lstinputlisting{src/bab-07/app.js}

\lstset{language=JavaScript,caption=controllers/user.js}
\lstinputlisting{src/bab-07/controllers/user.js}

\lstset{language=JavaScript,caption=models/db.js}
\lstinputlisting{src/bab-07/models/db.js}

\lstset{language=JavaScript,caption=package.json}
\lstinputlisting{src/bab-07/package.json}
